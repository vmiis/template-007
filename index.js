var vm_init=function(){
	...
	var last=function(){
		...
		setTimeout(function (){
			...
			$('head').append("<link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.3/css/bootstrap.min.css'>");
			...
			$.getScript('https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.3/js/bootstrap.min.js',function(){$vm.js_bootstrap=1;});
